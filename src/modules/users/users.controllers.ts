...
import { signup, login, updateUseradmin, updateUsersuperadmin } from './users.services.js';
...
export const updateUserToSuperAdminController = async (req: Request, res: Response) => {
  try {
    const { email } = req.body;
