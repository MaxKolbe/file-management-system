...
const sendEmail = (email: string, token: string, username: string, req: Request, res: Response) => {
    ...
    var mailOptions = { 
        ...
        <ol>
            <li>Click on the following link to access the password reset page: <a href="http://${req.headers.host}/resetPassword/${token}" target="_blank" rel="noopener noreferrer">RESET</a></li>
